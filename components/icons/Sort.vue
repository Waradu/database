...
<svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" v-else-if="type === 'linear'">
    ...
    <path d="M3 7h18M6 12h12M10 17h4" :stroke="color" :stroke-width="thickness" stroke-linecap="round"></path>
  </svg>
...
<svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" v-else-if="type === 'twotone'">
    ...
    <path d="M3 7h18" :stroke="color" :stroke-width="thickness" stroke-linecap="round"></path>
    <path opacity=".34" d="M6 12h12" :stroke="color" :stroke-width="thickness" stroke-linecap="round"></path>
    <path d="M10 17h4" :stroke="color" :stroke-width="thickness" stroke-linecap="round"></path>
  </svg>
