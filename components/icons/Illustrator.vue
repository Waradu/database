...
<svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" v-else-if="type === 'broken'">
    ...
    <path
      ...
      stroke-linejoin="round"
    ></path>
    <path d="M7.53 13.32h4.41" :stroke="color" :stroke-width="thickness" stroke-miterlimit="10"></path>
    <path
...
<svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" v-else-if="type === 'linear'">
    ...
    <path
      ...
      stroke-linejoin="round"
    ></path>
    <path d="M7.5 13.3h5.4" :stroke="color" :stroke-width="thickness" stroke-miterlimit="10"></path>
    <path
      d="M16.3 16v-5.3"
      :stroke="color"
      :stroke-width="thickness"
...
<svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" v-else-if="type === 'twotone'">
    ...
    <g opacity=".4" :stroke="color">
      <path
        ...
        stroke-linejoin="round"
      ></path>
      <path d="M7.3 13.3h5.4" :stroke-width="thickness" stroke-miterlimit="10"></path>
      <path
        d="M16.1 16v-5.3"
        :stroke-width="thickness"
        stroke-miterlimit="10"
        ...
        stroke-linejoin="round"
      ></path>
      <path d="M16.14 8.035v0" :stroke-width="(thickness+0.5)" stroke-linecap="round" stroke-linejoin="round"></path>
    </g>
  </svg>
